...
public class RLBotEntityRanking {
	
	public static TreeSet<EntityDoublePair> getEntityRanking(RLBot bot) {
...
//			Dbg.prn("add: "+e.toString()+" rank: "+rank+" ranking-size: "+ret.size());
	...
	public static String getRankingDebugInfo(RLBot bot) {
...
//			t += "\n";
	...
	public static float getRankForEntity(RLBot bot, Entity e) {
		NavConfig c = bot.nConfig;
	...
	public static float getDistanceFactor(RLBot bot, Entity e) {
		float dist = (float) RLBotGlobalNav.getDistanceFollowingMap(bot, bot.getBotPosition(), e.getObjectPosition());
	...
	public static float getEnemyCost(RLBot bot, Entity e) {
	...
	public static float getBotHealthDeficiency(RLBot bot, int addedHealth) {
		float h = bot.getBotHealth() + addedHealth;
		if (h > BotBase.maxHealth) h = BotBase.maxHealth;
		return 1f - h / (float)BotBase.maxHealth;
	}
	
	public static float getBotArmorDeficiency(RLBot bot, int addedArmor) {
	...
	public static float getBotAmmoDeficiency(RLBot bot, int addedAmmoIndex) {
		/**
		int BLASTER = 7, SHOTGUN = 8,
		SUPER_SHOTGUN = 9, MACHINEGUN = 10, CHAINGUN = 11, GRENADES = 12,
		GRENADE_LAUNCHER = 13, ROCKET_LAUNCHER = 14, HYPERBLASTER = 15,
...
//		Dbg.prn("owned ammo: "+ownedAmmo+" max ammo: "+maxAmmo);
	...
	public static float getItemHealthBenefit(RLBot bot, Entity e) {
	...
	public static float getItemArmorBenefit(RLBot bot, Entity e) {
	...
	public static float getItemWeaponBenefit(RLBot bot, Entity e) {
	...
	public static float getItemAmmoBenefit(RLBot bot, Entity e) {
		//FIXME:
	 ...
	 * @return
	 */
	private static int getWeaponFromAmmoIndex(RLBot bot, int am) {
